...
class TestThemeInstaller:
    ...
    def test_validate_theme_package_zip_valid(self, theme_installer, valid_theme_directory, tmp_path):
    ...
    def test_validate_theme_package_zip_multiple_themes(self, theme_installer, valid_theme_directory, tmp_path):
        ...
        with zipfile.ZipFile(zip_path, "w") as zipf:
            ...
            zipf.writestr("theme2/theme.json", json.dumps({"id": "theme2", "name": "Theme 2", "version": "1.0.0", "variables": {}}))
    ...
    def test_enumerate_themes_from_repo_auto_discovery(self, theme_installer, tmp_path, valid_theme_manifest):
