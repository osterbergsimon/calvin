...
// Support both service-id (for plugin component pattern) and direct url prop
...
// Get URL from prop (passed from ServiceViewer)
// The url prop is computed from service.url || service.config?.url in ServiceViewer
