...
export const settingsDestinations = [
  ...
  },
  {
    ...
    tabKey: "settings_tab_dashboard",
    tab: "appearance",
    keywords: ["ui", "theme", "appearance", "typeface", "font", "dark mode", "focus light"],
  },
  {
    id: "dashboard-kiosk",
    label: "Kiosk and touch controls",
    path: "Display / Kiosk & touch",
    category: "dashboard",
    tabKey: "settings_tab_dashboard",
    tab: "kiosk-touch",
    keywords: ["kiosk", "touch", "controls", "hide controls", "touch size"],
  },
  {
  ...
  },
  {
    ...
    keywords: ["calendar", "week", "time format", "weekend", "red days", "holidays", "events", "view"],
  },
  {
    id: "content-photos",
